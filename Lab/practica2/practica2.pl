...
menu_criterio:-
    ...
    ((OpcionCriterio=0,false);(ejecutar(OpcionCriterio),cls,menu_criterio)).
...
menu_reportes :-
    ...
    (
     ...
     Opcion=5->write('Reporte 5 \n');
     Opcion=6->write('Reporte 6 \n');
     Opcion=7->write('Reporte 7 \n');
     Opcion=8->write('Reporte 8 \n');
     Opcion=9->write('Reporte 9 \n');
     Opcion=0->false
    ),cls,menu_reportes.
